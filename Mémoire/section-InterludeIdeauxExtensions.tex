...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|c|c|}
			...
			nombre d'entiers rationnels qui sont de Carmichael dans un corps testé & 2930 \\\hline
			proportion d'entiers rationnels qui sont de Carmichael dans un corps testé & 51,2 \% \\\hline
		\end{tabular}
