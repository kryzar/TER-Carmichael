...
\section{Salvateurs corps cyclotomiques}
...
Pour tester si un nombre est de Carmichael dans un corps de nombres de donné, nous implémentons le critère de Korselt dans une fonction dédié. Pour plus de détails, nous invitons le lecteur à se référer à l'annexe \ref{annexe-ce}.
