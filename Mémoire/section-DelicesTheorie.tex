...
\begin{lemme}[identité (1) dans l'article]\label{identite-1}
...
\begin{theoreme}[réciproque du petit théorème de Fermat généralisé, 2.3 dans l'article]\label{ptf-reciproque}
...
\KwIn{$n$ (entier à tester), $\mathscr{K}$ (liste d'extensions galoisiennes de degré fini de $\Q$)}
