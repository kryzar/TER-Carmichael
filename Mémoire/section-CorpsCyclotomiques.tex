...
\begin{theoreme}[{\cite[th. 3.6]{article}}]\label{theoreme-3.6}
	Soit $n$ un entier rationnel composé ayant au moins trois facteurs premiers distincts. Alors il existe une infinité de corps cyclotomiques $K$ de la forme $K = \Q(\zeta_q)$, $q$ étant premier, tels que $\Disc(K)$ soit premier avec $n$, et que $n$ \emph{ne soit pas de Carmichael dans $K$}.
\end{theoreme}
