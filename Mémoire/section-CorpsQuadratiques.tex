...
\begin{theoreme}[{\cite[th. 2.5]{article}}]\label{theoreme-2.5}
	Soit $n$ un entier rationnel impair sans facteurs carrés. S'il existe un diviseur premier $p$ de $n$ vérifiant $$p^2 - 1 \nmid n^2 - 1,$$ alors il existe une infinité de corps quadratiques $K$, de discriminants premiers avec $n$, dans lesquels $n$ n'est pas de Carmichael.
\end{theoreme}
...
\begin{theoreme}[Howe, 2000]
	Il existe un entier rationnel $h$ qui soit à la fois composé et de Carmichael dans tout corps quadratique de discriminant premier avec $h$.
\end{theoreme}
